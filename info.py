...
DEFAULT_LOG_CHANNEL = -1003240732974
LOG_CHANNEL = int(environ.get("LOG_CHANNEL") or DEFAULT_LOG_CHANNEL)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002240208831') or '-1002240208831')
